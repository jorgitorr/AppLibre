...
/**
 * si buscas por nombre
 * te devuelve el id,
 * si buscas por id te devuelve
 * todo
 */
data class SuperHero (
    val id:Int,
    val powerStats:List<String>,
    ...
    override fun toString(): String {
        return "SuperHero(id=$id, powerStats=$powerStats, biography=$biography, appearance=$appearance, work=$work, image=$image, name='$name')"
    }
}

/*
Esto es todo lo que tiene la API
"response": "success",
  "id": "70",
  "name": "Batman",
  "powerstats": {
